...
#undef this_module
#endif
#define this_module ngx_stream_request_set_module
...
static ngx_int_t ngx_stream_set_get_variable (ngx_stream_request_t *r,
...
ngx_module_t  ngx_stream_request_set_module = {
  NGX_MODULE_V1,
...
static char * ngx_stream_set(ngx_conf_t *cf, ngx_command_t *cmd, void *conf) {
  ...
  ccv.cf = cf;
  ccv.value = &value[2];
  ccv.complex_value = ngx_pcalloc(cf->pool, sizeof(ngx_stream_request_complex_value_t));
...
static ngx_int_t ngx_stream_set_get_variable (ngx_stream_request_t *r,
                                              ...
                                              , uintptr_t data) {
  ngx_stream_request_complex_value_t *complex = (ngx_stream_request_complex_value_t*)data;
  ngx_str_t text;
